---
slug: understanding-shift-left-security
title: Understanding Shift Left Security
authors: [narendra]
tags: [devsecops, cicd-security, appsec, github-actions]
---

Security feedback should come while the developer still has context.
...
For this topic, the practical risk is simple: a secret or vulnerable package reaches main because checks ran too late.
