---
slug: github-actions-security-fundamentals
title: GitHub Actions Security Fundamentals
authors: [narendra]
tags: [devsecops, cicd-security, appsec, github-actions]
---

GitHub Actions can build and deploy, so permissions matter.
...
For this topic, the practical risk is simple: a malicious workflow abuses write-all token permissions.

## What Usually Goes Wrong

Common mistakes I have seen in real projects:

- Workflow token has write-all permission.
- Third-party actions are not pinned.
- pull_request_target is used without understanding risk.
- Secrets are available to jobs that do not need them.
