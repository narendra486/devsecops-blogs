...
CI/CD security is practical engineering work. In this part, we will learn **OIDC and Secure Cloud Deployments** slowly, with real examples and simple explanations.
...
OIDC and Secure Cloud Deployments is part of a bigger secure delivery model.
