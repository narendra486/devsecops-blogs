---
slug: dependency-and-sca-security
title: Dependency and SCA Security
authors: [narendra]
tags: [devsecops, cicd-security, appsec, github-actions]
---

CI/CD security is practical engineering work. In this part, we will learn **Dependency and SCA Security** slowly, with real examples and simple explanations.
...
Dependency and SCA Security is part of a bigger secure delivery model.
