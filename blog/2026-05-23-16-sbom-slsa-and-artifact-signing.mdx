---
slug: sbom-slsa-and-artifact-signing
title: SBOM, SLSA, and Artifact Signing
authors: [narendra]
tags: [devsecops, cicd-security, appsec, github-actions]
---

CI/CD security is practical engineering work. In this part, we will learn **SBOM, SLSA, and Artifact Signing** slowly, with real examples and simple explanations.
...
SBOM, SLSA, and Artifact Signing is part of a bigger secure delivery model.
