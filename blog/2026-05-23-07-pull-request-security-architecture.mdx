---
slug: pull-request-security-architecture
title: Pull Request Security Architecture
authors: [narendra]
tags: [devsecops, cicd-security, appsec, github-actions]
---

CI/CD security is practical engineering work. In this part, we will learn **Pull Request Security Architecture** slowly, with real examples and simple explanations.
...
Pull Request Security Architecture is part of a bigger secure delivery model.
