---
slug: scm-security-with-github
title: SCM Security With GitHub
authors: [narendra]
tags: [devsecops, cicd-security, appsec, github-actions]
---

Source code management is the first security boundary.
...
For this topic, the practical risk is simple: a weak branch rule allows risky code to merge.
...
- CODEOWNERS is missing for workflow changes.
- Old users still have write access.
- Rulesets are not applied to all important branches.
