---
slug: securing-developers-before-git-push
title: Securing Developers Before Git Push
authors: [narendra]
tags: [devsecops, cicd-security, appsec, github-actions]
---

CI/CD security is practical engineering work. In this part, we will learn **Securing Developers Before Git Push** slowly, with real examples and simple explanations.
...
Securing Developers Before Git Push is part of a bigger secure delivery model.
