...
description: Why CI/CD pipelines are production trust boundaries and how attackers abuse weak delivery systems.
---
...
Why CI/CD pipelines are production trust boundaries and how attackers abuse weak delivery systems.
...
```yaml
name: cicd-security-fundamentals
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run CI/CD Security Fundamentals checks here"
...
CI/CD Security Fundamentals is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
