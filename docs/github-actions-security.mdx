...
description: How to secure workflows, jobs, runners, actions, secrets, permissions, and deployment paths.
---
...
How to secure workflows, jobs, runners, actions, secrets, permissions, and deployment paths.
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run GitHub Actions Security checks here"
...
GitHub Actions Security is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
