...
description: Secure self-hosted runners, reduce persistence risk, and isolate untrusted workloads.
---
...
Secure self-hosted runners, reduce persistence risk, and isolate untrusted workloads.
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run Self-Hosted Runner Security checks here"
...
Self-Hosted Runner Security is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
