...
description: Protect dependencies, build systems, maintainers, artifacts, and release provenance.
---
...
Protect dependencies, build systems, maintainers, artifacts, and release provenance.
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run Supply Chain Security checks here"
...
Supply Chain Security is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
