...
description: Generate software bills of materials and improve build provenance maturity using SLSA principles.
---
...
Generate software bills of materials and improve build provenance maturity using SLSA principles.
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run SBOM and SLSA checks here"
...
SBOM and SLSA is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
