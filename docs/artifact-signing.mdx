...
description: Sign and verify container images and artifacts using Sigstore and Cosign.
---
...
Sign and verify container images and artifacts using Sigstore and Cosign.
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run Artifact Signing checks here"
...
Artifact Signing is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
