...
description: GitHub-native security controls for repositories, organizations, rulesets, Dependabot, and code ownership.
---
...
GitHub-native security controls for repositories, organizations, rulesets, Dependabot, and code ownership.
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run GitHub Security checks here"
...
GitHub Security is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
