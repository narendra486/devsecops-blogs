...
description: Secure Dockerfiles, base images, image builds, package vulnerabilities, and runtime defaults.
---
...
Secure Dockerfiles, base images, image builds, package vulnerabilities, and runtime defaults.
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run Container Security checks here"
...
Container Security is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
