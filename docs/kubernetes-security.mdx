...
description: Secure Kubernetes manifests and deployment controls before workloads reach clusters.
---
...
Secure Kubernetes manifests and deployment controls before workloads reach clusters.
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run Kubernetes Security in CI/CD checks here"
...
Kubernetes Security in CI/CD is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
