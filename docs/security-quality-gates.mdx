...
description: Block pull requests and releases based on practical risk thresholds.
---
...
Block pull requests and releases based on practical risk thresholds.
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run Security Quality Gates checks here"
...
Security Quality Gates is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
