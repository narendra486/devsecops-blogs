...
description: Use code-based policies for repeatable and reviewable security decisions.
---
...
Use code-based policies for repeatable and reviewable security decisions.
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run Policy as Code checks here"
...
Policy as Code is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
