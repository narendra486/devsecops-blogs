...
description: How to protect source code management systems, branches, commits, pull requests, and repository permissions.
---
...
How to protect source code management systems, branches, commits, pull requests, and repository permissions.
  ...
  security-check:
    ...
    steps:
      ...
      - name: Run security control
        run: |
          echo "Run SCM Security checks here"
...
SCM Security is not only a tool topic. It is part of secure software delivery. Start with the risk, place the control in the right CI/CD stage, and make feedback easy for developers to act on.
